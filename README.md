...
Для этого я могу воспользоваться такой командой.
...
By default, the argument **-head** is equal to **-1** , and the argument **-tail** is null. To remove only the last line from the output, you can write like this.
